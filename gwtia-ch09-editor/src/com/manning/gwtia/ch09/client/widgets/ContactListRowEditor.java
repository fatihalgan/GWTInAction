...
public class ContactListRowEditor extends Composite implements LeafValueEditor<ContactProxy> {
	...
	private static ContactListRowEditorUiBinder uiBinder = GWT.create(ContactListRowEditorUiBinder.class);

	interface ContactListRowEditorUiBinder extends UiBinder<Widget, ContactListRowEditor> {
	}
