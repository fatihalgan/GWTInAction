...
public class ListAllContactsEditor extends Composite 
	implements CompositeEditor<List<ContactProxy>, ContactProxy, ContactListRowEditor>{
	
	Logger log = Logger.getLogger("");
	
	interface ListAllContactEditorUiBinder extends UiBinder<Widget, ListAllContactsEditor> {
	}
	...
	@Override
	public void setEditorChain(com.google.gwt.editor.client.CompositeEditor.EditorChain<ContactProxy, 
		ContactListRowEditor> chain) {
		editorChain = chain;
	}
}
