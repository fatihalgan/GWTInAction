...
public class Examples implements EntryPoint, ValueChangeHandler<String> {
	...
	public void onValueChange(ValueChangeEvent<String> event) {
		...
		if(page == null || page.equals("")) examples.showIntro();
		// Else check what the token is and call the appropriate method.
		else if (page.equals(HistoryTokens.EMPLOYEES)) examples.showEmployees();
		else if (page.equals(HistoryTokens.PHONEBOOK)) examples.showPhoneBook();
		else if (page.equals(HistoryTokens.CONTACTS)) examples.showContacts();
		else if (page.equals(HistoryTokens.LIST_1)) examples.showList1();
		else if (page.equals(HistoryTokens.LIST_2)) examples.showList2();
	}
