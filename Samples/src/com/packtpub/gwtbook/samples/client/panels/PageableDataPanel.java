...
public class PageableDataPanel extends SamplePanel {
	...
	private String[] customerTableHeaders = new String[] { "Name", "City", "Zip Code", "State", "Phone" };
	...
	public static SinkInfo init() {
		return new SinkInfo("Pageable Lists", "Page through a long list of data") {
	...
	public PageableDataPanel() {
		...
		infoPanel.add(new HTML("<div class='infoProse'>Create lists that can be paged by fetching data from the server on demand when we go forward and backward in the list.</div>"));
