...
public class FlickrEditableLabelPanel extends SamplePanel {
	...
	public static SinkInfo init() {
		return new SinkInfo("Flickr Style Label", "Flickr Style Editable Label") {
			public SamplePanel createInstance() {
				return new FlickrEditableLabelPanel();
			}
		};
	}
	
	public FlickrEditableLabelPanel() {
		HorizontalPanel infoPanel = new HorizontalPanel();
		infoPanel.add(new HTML("<div class='infoProse'>This example demonstrates the creation of a flickr style editable label. Clicking on the label converts it into a TextBox with a Save and Cancel button at the bottom. You can modify the text and either save your changes or cancel, and it will once again change back to a label.</div>"));
