...
import com.packtpub.gwtbook.samples.client.DynamicListService;
import com.packtpub.gwtbook.samples.client.DynamicListServiceAsync;

public class DynamicListPanel extends SamplePanel {

	final DynamicListServiceAsync dynamicListsService = (DynamicListServiceAsync) GWT
			.create(DynamicListService.class);
	...
	public DynamicListPanel() {
			...
			public void onCellClicked(SourcesTableEvents sender, int row,
				...
				AsyncCallback callback = new AsyncCallback() {
					public void onFailure(Throwable caught) {
						Window.alert("Error calling the Dynamic Lists service to get the brands."
								+ caught.getMessage());
					}
		...
		brands.addTableListener(new TableListener() {
			public void onCellClicked(SourcesTableEvents sender, int row,
				...
				AsyncCallback callback = new AsyncCallback() {
					public void onFailure(Throwable caught) {
						Window.alert("Error calling the Dynamic Lists service to get the models."
								+ caught.getMessage());
					}
				...
				dynamicListsService.getModels(
						manufacturers.getText(selectedManufacturer, cell),
		...
		AsyncCallback callback = new AsyncCallback() {
			...
			public void onFailure(Throwable caught) {
				Window.alert("Error calling the Dynamic Lists service to get the manufacturers."
						+ caught.getMessage());
			}
		};
