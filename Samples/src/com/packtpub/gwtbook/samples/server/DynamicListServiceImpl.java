...
public class DynamicListServiceImpl extends RemoteServiceServlet implements DynamicListService {
	
	private HashMap data = new HashMap();

	public DynamicListServiceImpl() {
		super();
		loadData();
	}
	...
	public List getModels(String manufacturer, String brand) {
		...
		for (Iterator iter = ((ArrayList) mfrBrands.get(brand)).iterator(); iter
				.hasNext();) {
