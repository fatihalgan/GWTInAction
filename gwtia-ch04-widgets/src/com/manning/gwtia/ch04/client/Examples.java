...
public class Examples implements EntryPoint, ValueChangeHandler<String> {
	...
	public void onValueChange(ValueChangeEvent<String> event) {
		...
		if((page == null) || page.equals("")) {} //showHomePage();
		// Else check what the token is and call the appropriate method.
		else if (page.equals(HistoryTokens.CREATE)) examples.showCreate();
		else if (page.equals(HistoryTokens.EXTEND)) examples.showExtend();
		else if (page.equals(HistoryTokens.COMPOSITE)) examples.showComposite();
		else if (page.equals(HistoryTokens.LAYOUT)) examples.showLayout();
		else if (page.equals(HistoryTokens.SPLITLAYOUT)) examples.showSplitLayout();
		else if (page.equals(HistoryTokens.STACKLAYOUT)) examples.showStackLayout();
		else if (page.equals(HistoryTokens.DOCKLAYOUT)) examples.showDockLayout();
		else if (page.equals(HistoryTokens.ANIMATION)) examples.showAnimationPanel();
		else if (page.equals(HistoryTokens.SAFEHTML)) examples.showSafeHtml();		
		else examples.showInstructionsPanel();
