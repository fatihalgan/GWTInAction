...
public class AudioExample extends Composite {
    ...
    interface Resources extends ClientBundle {
        @Source("Cant_ge-Michael_-1909.wav") 
        public DataResource getBlues();
        @Source("Smoot-calpomat-4673.wav") 
        public DataResource getSmooth();
        @Source("Eriks_E-Erik_Rea-154.wav") 
        public DataResource getElectro();
    }
