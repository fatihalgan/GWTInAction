...
public class PhotoCellWithUiBinder extends AbstractCell<PhotoDetails> {
	...
	interface MyUiRenderer extends UiRenderer {
		...
		void onBrowserEvent(PhotoCellWithUiBinder cell, NativeEvent event, Element parent, 
			PhotoDetails value, Context context, ValueUpdater<PhotoDetails> valueUpdaterer);
	}
	...
	@Override
	public void render(com.google.gwt.cell.client.Cell.Context context, PhotoDetails value, 
		SafeHtmlBuilder sb) {
		if (value != null) renderer.render(sb, value.getTitle(), value.getLargeUrl(),
