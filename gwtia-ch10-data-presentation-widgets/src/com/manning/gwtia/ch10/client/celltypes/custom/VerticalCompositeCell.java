...
public class VerticalCompositeCell extends CompositeCell<PhotoDetails> {
	...
	@Override
	public void render(Context context, PhotoDetails value, SafeHtmlBuilder sb) {
	...
	@Override
	protected <X> void render(Context context, PhotoDetails value, SafeHtmlBuilder sb, 
		HasCell<PhotoDetails, X> hasCell) {
