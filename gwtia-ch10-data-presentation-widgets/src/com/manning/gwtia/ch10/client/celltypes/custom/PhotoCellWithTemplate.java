...
public class PhotoCellWithTemplate extends AbstractCell<PhotoDetails>{
	...
	interface Template extends SafeHtmlTemplates {
		@Template("<table>" + "<tr height=40px>" + 
				"<td width=80px rowspan=2 bgcolor=\"{1}\"/>&nbsp</td>" +
				"<td>{0}</td>" + "</tr>" + "<tr>" + "<td>Taken: {2}</td>" + "</tr>" +
				"</table>")
	...
	public void render(com.google.gwt.cell.client.Cell.Context context,
			...
			if(value!=null)
				sb.append(template.photo(value.getTitle(), value.getLargeUrl(), 
	...
	public void onBrowserEvent(Context context, Element parent, PhotoDetails value,
		NativeEvent event, ValueUpdater<PhotoDetails> valueUpdater) {
