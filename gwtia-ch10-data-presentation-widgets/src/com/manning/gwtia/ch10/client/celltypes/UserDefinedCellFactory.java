...
public class UserDefinedCellFactory {
	...
	static private PhotoDetails getPhoto() {
		if (thePhoto == null) thePhoto = new PhotoDetails();
		Date date;
		try{
	...
	public static CellWidget<PhotoDetails> buildUserDefinedTemplate() {
		...
		CellWidget<PhotoDetails> cellWidget = new CellWidget<PhotoDetails>(photo);
		getPhoto();
	...
	public static CellWidget<PhotoDetails> buildComposite() {
		...
		CompositeCell<PhotoDetails> compCell = new CompositeCell<PhotoDetails>(cells);
		getPhoto();
		thePhoto.setLargeUrl("yellow");
		CellWidget<PhotoDetails> cellWidget = new CellWidget<PhotoDetails>(compCell);
		cellWidget.setValue(thePhoto);
		return cellWidget;
	}
