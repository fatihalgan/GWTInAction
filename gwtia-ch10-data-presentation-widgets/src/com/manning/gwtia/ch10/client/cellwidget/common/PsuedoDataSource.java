...
public class PsuedoDataSource {
	...
	private String[] titles1 = new String[] { "walking", "eating", "shooting",
		"going", "hiding", "running", "swimming", "playing", "stopping", "dancing" };
	...
	public static List<PhotoDetails> createData(int dataSize) {
		if (instance == null) instance = new PsuedoDataSource();
	...
	public static void populate(final List<PhotoDetails> theList, 
		final ListDataProvider<PhotoDetails> dataListProvider){
