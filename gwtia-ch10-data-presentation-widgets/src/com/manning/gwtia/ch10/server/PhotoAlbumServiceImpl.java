...
public class PhotoAlbumServiceImpl extends RemoteServiceServlet implements PhotoAlbumService {
	...
	public List<AsyncYears> getYearsList(int rangeStart, int rangeLength){
		...
		while(iter.hasNext()) toReturn.add(new AsyncYears(iter.next().getYear()));
