...
var $strongName = 'F4DCC171C655A1E1E40F93F697D183E7';
var $gwt = {};
...
;
stringCastMap = {3:1, 128:1, 23:1, 2:1};
modernizeBrowser();
...
defineClass(61, 118, {}, StackTraceCreator$CollectorModern);
...
;
var Lcom_google_gwt_core_client_impl_StackTraceCreator$CollectorModern_2_classLit = createForClass('com.google.gwt.core.client.impl', 'StackTraceCreator/CollectorModern', 61);
...
defineClass(104, 126, {}, CloseEvent_0);
...
function $doFire(this$static, event_0){
  ...
  try {
    ...
    while (this$static.isReverseOrder?it.hasPrevious():it.hasNext()) {
      ...
      try {
        event_0.dispatch(dynamicCast(handler, 129));
      }
       catch ($e0) {
        $e0 = wrap($e0);
        if (instanceOf($e0, 4)) {
  ...
  if (this$static.deferredDeltas) {
    try {
      for (c$iterator = new AbstractList$IteratorImpl(this$static.deferredDeltas); c$iterator.i < c$iterator.this$01_0.size_1();) {
        c = (checkCriticalElement(c$iterator.i < c$iterator.this$01_0.size_1()) , dynamicCast(c$iterator.this$01_0.get_0(c$iterator.i++), 130));
...
function fromInt(value_0){
  ...
  if (value_0 > -129 && value_0 < 128) {
    rebase = value_0 + 128;
    boxedValues == null && (boxedValues = initDim(Lcom_google_gwt_lang_LongLibBase$LongEmul_2_classLit, $intern_1, 132, 256, 0, 1));
...
defineClass(85, 126, {}, Window$ClosingEvent);
...
;
var Lcom_google_gwt_user_client_ui_Panel_2_classLit = createForClass('com.google.gwt.user.client.ui', 'Panel', 122);
...
defineClass(75, 1, {129:1}, RootPanel$2);
...
defineClass(47, 122, $intern_9, SimplePanel);
...
defineClass(90, 1, {130:1}, SimpleEventBus$2);
...
defineClass(31, 44, {128:1}, StringBuilder);
...
;
var Ljava_util_AbstractCollection_2_classLit = createForClass('java.util', 'AbstractCollection', 120);
...
;
var Ljava_util_AbstractMap_2_classLit = createForClass('java.util', 'AbstractMap', 119);
...
;
var Ljava_util_AbstractSet_2_classLit = createForClass('java.util', 'AbstractSet', 121);
...
defineClass(24, 121, {35:1}, AbstractHashMap$EntrySet);
...
defineClass(45, 121, {35:1}, AbstractMap$1);
...
;
var Ljava_util_AbstractMapEntry_2_classLit = createForClass('java.util', 'AbstractMapEntry', 124);
...
defineClass(33, 123, $intern_11, ArrayList);
...
defineClass(79, 123, $intern_11, Collections$EmptyList);
...
defineClass(41, 121, {3:1, 35:1}, HashSet);
...
defineClass(52, 124, {9:1}, InternalJsStringMap$2);
