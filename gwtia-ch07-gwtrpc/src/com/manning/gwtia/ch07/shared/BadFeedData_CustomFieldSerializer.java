...
/**
 * A custom serializer for the BadFeedData class. This is an example of the code
 * you would need to write for when GWT is unable to automatically generate a
 * serializer for you.
 */
public class BadFeedData_CustomFieldSerializer {
	...
	/**
	 * Instantiate a new object instance, reading from the stream the number of
	 * parameters required to instantiate the instance.
	 *
	 * @param ssr
	 *            the stream reader
	 ...
	 *            the stream reader
	 * @param instance
	 *            the object instance to put the stream data into
	 * @throws SerializationException
	 *             the serialization exception
	 */
