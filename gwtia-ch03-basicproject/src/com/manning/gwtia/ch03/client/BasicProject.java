...
public class BasicProject implements EntryPoint, ValueChangeHandler<String> {
	...
	private void styleButtonUsingDOM() {
		...
		search.getElement().getStyle().setProperty("backgroundColor", "#ff000");
	...
	public void onValueChange(ValueChangeEvent<String> event) {
		...
		else if(page.equals(Pages.PRODUCTS.getText())) showProducts();
		else if (page.equals(Pages.CONTACT.getText())) showContact();
		else showHomePage();
	}
