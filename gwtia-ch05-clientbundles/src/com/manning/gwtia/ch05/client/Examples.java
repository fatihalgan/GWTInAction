...
public class Examples implements EntryPoint, ValueChangeHandler<String> {
	...
	public void onValueChange(ValueChangeEvent<String> event) {
		...
		else if (page.equals(HistoryTokens.DATA)) examples.showData();
		else if (page.equals(HistoryTokens.TEXT)) examples.showText();
		else if (page.equals(HistoryTokens.IMAGE)) examples.showImage();		
		else if (page.equals(HistoryTokens.CSS)) examples.showCss();
